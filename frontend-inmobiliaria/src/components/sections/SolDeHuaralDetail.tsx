...
export default function SolDeHuaralDetail() {
  const [currentHeroImage, setCurrentHeroImage] = useState(0);
  const [currentGalleryImage, setCurrentGalleryImage] = useState(0);

  // Imágenes Locales (CAMBIAR POR LAS DE HUARAL)
  const heroImages = ["OBRAS2/FONDO4.jpg", "OBRAS2/FONDO2.jpg", "OBRAS2/FONDO3.jpg"];
  
  // GALERÍA ESTILO MENORCA CON TÍTULOS (CAMBIAR POR LAS DE HUARAL)
  const galleryItems = [
    { src: "OBRAS2/C4.jpg"},
    { src: "OBRAS2/C1.jpg"},
    { src: "OBRAS2/C5.jpg"},
  ...
  const amenities = [
    ...
    { icon: <FaHandHoldingWater />, t: "Agua" },
    { icon: <FaFutbol />, t: "Canchas Deportivas" },
    { icon: <FaStore />, t: "Mercados" },
  ...
  // 🌟 FUNCIÓN: ENVIAR FORMULARIO A WHATSAPP (ACTUALIZADO A HUARAL) 🌟
  const handleFormSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const mensaje = `¡Hola! Quiero conocer más de *Sol de Huaral*.%0A%0A*Mis datos:*%0A👤 Nombre: ${nombre}%0A🪪 DNI: ${dni}%0A📱 Celular: ${celular}%0A✉️ Email: ${email}`;
    ...
    <div className="w-full bg-white font-montserrat min-h-screen text-[#0069b7] overflow-clip">
      ...
      <section className="relative w-full h-[65vh] md:h-[75vh] overflow-hidden bg-slate-100">
        ...
        <div className="absolute top-[20%] left-0 md:left-[8%] bg-[#0069b7] p-8 md:p-12 z-10 max-w-lg shadow-2xl border-l-8 border-[#f81200]">
          <h1 className="text-4xl md:text-6xl font-black text-white uppercase leading-[1.1] tracking-tight">
            TU FUTURO <br/>
            <span className="text-white">HOGAR TE</span> <br/>
            ESTÁ ESPERANDO
          </h1>
        </div>
            ...
            <div className="space-y-8">
              <div className="flex items-center gap-6">
                <div className="text-[#0069b7] font-black text-3xl leading-none">
                  SOL DE <br/> <span className="text-[#0069b7] text-lg">HUARAL</span>
                </div>
                <div className="flex gap-2">
                  <span className="bg-[#f81200] text-white px-3 py-1 text-[10px] font-bold uppercase rounded">Norte</span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="border border-[#0069b7]/20 rounded-xl p-4 flex flex-col items-center justify-center text-center">
                  ...
                  <p className="text-xs font-bold text-[#0069b7]">Km. 7 de la antigua <br/> Panamericana Norte</p>
                </div>
                <div className="border border-[#0069b7]/20 rounded-xl p-4 flex flex-col items-center justify-center text-center">
                  <FaRulerCombined className="text-[#0069b7] text-2xl mb-2" />
                  <p className="text-xs font-bold text-[#0069b7]">Lotes desde <br/> <span className="text-lg">120 m²</span></p>
                </div>
                <div className="border border-[#0069b7] bg-[#f0f9ff] rounded-xl p-4 flex flex-col items-center justify-center text-center">
                  ...
                  <p className="text-2xl font-black text-[#0069b7]">S/ 10,000</p>
                </div>
              </div>

              <p className="text-gray-600 text-sm leading-relaxed text-justify">
                Sumérgete en la serenidad de Sol de Huaral, donde la naturaleza se combina armoniosamente con la tranquilidad de un entorno único. Te invitamos a desconectarte y disfrutar de una vida llena de comodidades, con áreas verdes, pórtico de ingreso y servicios ecoamigables. ¡Bienvenido al refugio que desarrollaremos en Huaral!
              </p>
            </div>
              ...
              >
                <div className="text-center mb-6">
                  <h3 className="text-[22px] font-black text-[#0069b7] leading-tight mb-2 tracking-tight">
                    ¡Quiero conocer más de <br/> Sol de Huaral!
                  </h3>
      ...
      <div className="w-full bg-slate-50 pt-16 pb-12">
        <div className="container mx-auto px-4 mb-8 relative z-10">
          ...
          <p className="text-sm text-gray-500 mb-8 text-center">Atención de lunes a domingo. <br/> <b>Horario:</b> 9:00 a.m. a 6:00 p.m.</p>
          ...
          <div className="flex justify-center -mb-20">
            <div className="bg-white p-8 rounded-3xl shadow-2xl w-full max-w-sm text-center border-t-4 border-[#f81200]">
              ...
              <p className="text-xs text-gray-500 mb-6 font-bold">Km. 7 Pan. Norte Antigua</p>
              <a 
                href="https://maps.app.goo.gl/HCfLJ8PNjz5EbK5q8" 
                target="_blank" 
        ...
        <div className="w-full h-[550px] shadow-inner border-y border-gray-200 relative z-0 mt-8">
           {/* REEMPLAZAR SRC CON EL LINK DEL MAPA DE HUARAL */}
           <iframe 
             src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d4638.996705295667!2d-77.29313282494857!3d-11.42120838876949!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMTHCsDI1JzE2LjQiUyA3N8KwMTcnMjYuMCJX!5e1!3m2!1ses!2spe!4v1775955046160!5m2!1ses!2spe" 
